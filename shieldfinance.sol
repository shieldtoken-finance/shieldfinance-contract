...
contract ShieldFinance is BEP20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "SDF";
  string constant tokenSymbol = "Shield Finance";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 100000000*10**18;
  uint256 public basePercent = 1000;
  uint256 public MaxTotalBurn = 99800000*10**18;
  ...
  function findOnePercent(uint256 value) public view returns (uint256)  {
    ...
    uint256 halfPercent = roundValue.mul(basePercent).div(10000);
    return halfPercent;
  }
